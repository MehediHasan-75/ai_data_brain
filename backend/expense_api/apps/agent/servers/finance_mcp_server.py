...
User identity is injected via Middleware Context Injection per tool call.
"""
...
from expense_api.apps.agent.servers.base import ResponseBuilder, DataValidator, OperationLogger
...
class FinanceToolsManager:
    """Stateless manager: every method requires a user_id explicitly."""
    
    def __init__(self):
        self.validator = DataValidator()

    @staticmethod
    async def _owns_table(table_id: int, user_id: int) -> bool:
    ...
    async def add_table_row(user_id: int, table_id: int, row_data) -> str:
        try:
            if not await FinanceToolsManager._owns_table(table_id, user_id):
...
async def add_table_row(
    ...
    return await tools_mgr.add_table_row(user_id, table_id, row_data)
...
async def update_table_row(
    ...
    return await tools_mgr.update_table_row(user_id, table_id, row_id, new_data)
...
async def delete_table_row(
    ...
    return await tools_mgr.delete_table_row(user_id, table_id, row_id)
...
async def get_table_content(
    ...
    """
    return await tools_mgr.get_table_content(user_id, table_id)
...
async def add_table_column(
    ...
    return await tools_mgr.add_table_column(user_id, table_id, header)
...
async def delete_table_columns(
    ...
    return await tools_mgr.delete_table_columns(user_id, table_id, headers_to_remove)
...
async def update_table_metadata(
    ...
    return await tools_mgr.update_table_metadata(user_id, table_id, table_name, description)
...
async def delete_table(
    ...
    return await tools_mgr.delete_table(user_id, table_id)
